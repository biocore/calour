...
class MTests(Tests):
    ...
    def test_merge_identical(self):
        ...
        self.assertCountEqual(newexp.sample_metadata['_calour_merge_ids']['S1'], ['S1', 'S2', 'S3', 'S4', 'S5', 'S6', 'S7', 'S8', 'S9', 'S10', 'S11'])
        self.assertCountEqual(newexp.sample_metadata['_calour_merge_ids']['S12'], ['S12', 'S13', 'S14', 'S15', 'S16', 'S17', 'S18', 'S19', 'S20'])
